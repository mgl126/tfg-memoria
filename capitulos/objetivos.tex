...
Por otro lado, la precisión de posicionamiento mediante GPS resulta insuficiente para muchas tareas de inspección detallada. La interfaz, aunque funcional, no destaca por su intuitividad y requiere cierto periodo de adaptación. Las funcionalidades más avanzadas requieren suscripción a servicios Trimble Connect, generando costes recurrentes. Por útlimo, no ofrece experiencias VR inmersivas, limitándose a AR móvil.
...
\end{itemize}
La consecución de estos objetivos permitirá terminar con un prototipo funcional que demuestre la viabilidad técnica y el valor potencial de integrar tecnologías AR/VR con metodologías BIM en el sector de la construcción, contribuyendo tanto al aprendizaje personal la de este campo emergente.
