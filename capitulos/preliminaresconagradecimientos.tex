...
\thispagestyle{empty}
    ...
    Este trabajo propone una solución con el desarrollo de una aplicación que integre Realidad Aumentada y Realidad Virtual en el flujo de trabajo de construcción, permitiendo visualizar modelos BIM directamente en éstas. La investigación previa identificará las necesidades específicas del sector y evaluará qué tecnologías y enfoques resultan más efectivos para cada tipo de tarea.
...
\vspace{1cm}
    ...
    Por último, quiero agradecer también a mis compañeros del grupo de ABP, por haber hecho de ese proyecto incluso de esa magnitud un proceso ameno y en el que me lo he llegado a pasar bien.
...
\begin{quote}
``\textit{\textit{I will fight for my future! I will fight alongside the future that everyone created for me!}
\textit{It’s not for anyone else’s sake but my own!}
}
\citep{Hajime}
...
\clearpage %salta a nueva página impar
\chapter*{}
