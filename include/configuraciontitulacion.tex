...
\definecolor{biomedica}{RGB}{79,170,137}	% Biomédica
...
% Másteres
	...
	\else \if\IDtitulo L % Ciberseguridad
		...
		\newcommand{\colortexto}{blanco}
	\else \if\IDtitulo M % Bioomédica
		% Logos
		\newcommand{\logoFacultadPortada}{include/logos-universidad/LogoEPSBlanco}
		\newcommand{\logoGradoPortada}{include/logos-titulaciones/LogoMasterBiomedicaColor}
		\newcommand{\logoGrado}{include/logos-titulaciones/LogoMasterBiomedicaNegro}
		% Texto
		\newcommand{\miGrado}{Máster Universitario en Ingeniería Biomédica}
		\newcommand{\tipotrabajo}{Trabajo Fin de Máster}
		% Color
		\newcommand{\colorgrado}{biomedica}
		\newcommand{\colortexto}{blanco}        
